describe('feed', () => {
  ...
  it('should render the views-count', () => {
    cy.visit(
      '/iframe.html?id=feedfootercomponent--metrics&args=metrics.totalReach:11382;metrics.shares:;metrics.likes:;'
    );
  ...
  it('should render the likes count', () => {
    cy.visit(
      '/iframe.html?id=feedfootercomponent--metrics&args=metrics.likes:59;metrics.totalReach:;metrics.shares:;'
    );
  ...
  it('should render the shares count', () => {
    cy.visit(
      '/iframe.html?id=feedfootercomponent--metrics&args=metrics.shares:100;metrics.likes:;metrics.totalReach:;'
    );
